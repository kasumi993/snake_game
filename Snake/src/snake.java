...
class Snake extends JFrame implements KeyListener, Runnable {
    ...
    Snake() {
        ...
        /*Image img;
        img= Toolkit.getDefaultToolkit().createImage("floor.png");
        p1.drawImage(img,0,0,this);*/
    ...
    public void creatbar() {
        ...
        game = new JMenu("Options");

        JMenuItem newgame = new JMenuItem("Recommencer");
